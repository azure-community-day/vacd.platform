...
namespace ConsoleSync
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Value for AZURE_WEBAPP_PUBLISH_PROFILE
            ...
            //Value for AZURE_WEBAPP_NAME
            var secretValue2 = System.Text.Encoding.UTF8.GetBytes(args[2]);
            var sealedPublicKeyBox2 = Sodium.SealedPublicKeyBox.Create(secretValue, publicKey);
